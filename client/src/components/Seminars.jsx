...
import foodka from "../assets/img/foodka.jfif";
      ...
      <div id="talks" className="row flex justify-content-center">
            ...
            <div className="card-body">
              <div className="card-text CardText text-center">
                <h1 className="h2 text-center mt-3">
                  Bootstraped Journey of an Entrepreneur
                </h1>
              </div>
            </div>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div
            ...
            onClick={() => {
              window.location.href =
                "https://www.linkedin.com/posts/ieee-iemsb_register-at-httpslnkdinech2hrzd-ieee-activity-7045032032195813377-nkC5?utm_source=share&utm_medium=member_android";
            }}
          >
            <img className="card-img-top" src={foodka} alt="CardImage" />
            <div className="card-body">
              <div className="card-text CardText text-center">
                <h1 className="h2 text-center mt-3">
      ...
      <div id="talks" className="row flex justify-content-center">
        <div className="col-lg-4 col-md-6">
          <div
            ...
            onClick={() => {
              window.location.href =
                "https://www.linkedin.com/posts/ieee-iemsb_register-here-elevate2023coinregister-activity-7046100219326840832-JnAJ?utm_source=share&utm_medium=member_android";
            }}
          >
            <img className="card-img-top" src={subodh} alt="CardImage" />
            <div className="card-body">
              <div className="card-text CardText text-center">
